...
aria2c --enable-rpc --rpc-listen-all=false --rpc-listen-port 6800 --check-certificate=false\
   ...
   --follow-torrent=mem --split=10 --bt-tracker-connect-timeout=300 --bt-stop-timeout=600 \
   ...
   --user-agent=Transmission/2.77 --peer-id-prefix=-TR2770- --peer-agent=Transmission/2.77
